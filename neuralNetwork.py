...
# hidden_neuron_1 = Neuron(neuron_inputs, neuron_weights, Random.random())
# hidden_neuron_2 = Neuron(neuron_inputs, neuron_weights, Random.random())
...
# print(output_neuron_1.sigmoid(), output_neuron_2.sigmoid(), sep=" ")